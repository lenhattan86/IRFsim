...
//  public static double[] reportBETAs = {10,1,0.1};
	public static double[] reportBETAs = {5,1,0.2};
...
//  public static double[] cheatedMemory = {0.0, 0.0, -0.2};
  ...
  public static int[] jobIterations = {1, 2, 3};
//  public static double[] BETAs = {1,1,1};
  ...
  public static double[] compuationToMemRatios = {20, 10, 5}; 
}
