...
public class SessionData {
  ...
  public static double[] singlePeriods  = {800.0};
  public static int[] singleJobNums = {50};
//  public static double[] singleAlphas = {1.0};
  public static double[] singleAlphas = {1.0*scaleFactor};
  
  // multiple periodic sessions
  public static double[] m2pleStartTimes = {1.0, 1000.0};
  public static double[] m2pleAlphaDurations = {10.0, 40.0}; 
  public static double[] m2plePeriods  = {100.0, 300.0};
  public static int[] m2pleJobNums = {2, 2};
  public static double[] m2pleAlphas = {1.0*scaleFactor, 1.0*scaleFactor};
  
  // aperiodic sessions
  public static double[] a3StartTimes = {20, 50.0, 200.0};
  public static double[] a3AlphaDurations = {10.0, 30.0, 20.0}; 
